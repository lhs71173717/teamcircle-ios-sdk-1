...
/**
  ...
  *  @param aPageSize 每次期望获取的社区数量。取值范围为 [1,20]。如果小于 0 则一次返回用户加入的所有群组。
  ...
  *  @param aPageSize           The number of groups that you expect to get on each page. The value range is  [1,20]. If you pass a value less than 0, all groups that you joined will be returned in one go.
